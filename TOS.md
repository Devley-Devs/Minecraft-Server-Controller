...
These Terms of Use constitute a legally binding agreement made between you, whether personally or on behalf of an entity (“you”) and `Yuvaraja#1073`, doing business as **Minecraft Server Controller** Bot ("**Minecraft Server Controller** Bot", “we”, “us”, or “our”), concerning your access to and use of the **Minecraft Server Controller** Bot as well as any other media form, website, media channel, mobile website or mobile application related, linked, or otherwise connected thereto (collectively, the “Bot”). You agree that by accessing the Bot, you have read, understood, and agree to be bound by all of these Terms of Use. IF YOU DO NOT AGREE WITH ALL OF THESE TERMS OF USE, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE BOT AND YOU MUST DISCONTINUE USE IMMEDIATELY.
...
- you are not a minor in the jurisdiction in which you reside, or if a minor, you have received parental permission to use the Bot
- you will not access the Discord Bot through automated or non-human means, whether through a bot, script or otherwise
...
You can cancel your subscription at any time. Your cancellation will take effect immediately.
